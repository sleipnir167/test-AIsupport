...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      showSidebarSystemAnalysis: s.showSidebarSystemAnalysis  ?? true,
      showSidebarRagChat:        s.showSidebarRagChat         ?? true,
      showSidebarGenerate:       s.showSidebarGenerate        ?? true,
      showSidebarTestItems:      s.showSidebarTestItems       ?? true,
      showSidebarExport:         s.showSidebarExport          ?? true,
      showSidebarReview:         s.showSidebarReview          ?? true,
    })
  } catch {
    return NextResponse.json({
      showAiLogsTab: true,
